...
const UI_STRINGS = {
  en: {
    ...
    bazmLoginPrompt: "Sign in from the top of the page to join a Bazm", bazmLoggedInAs: "Signed in as",
    awSignIn: "Sign in",
  ...
  hi: {
    ...
    bazmLoginPrompt: "बज़्म में शामिल होने के लिए पेज के ऊपर से लॉगिन करें", bazmLoggedInAs: "लॉगिन है",
    awSignIn: "लॉगिन करें",
  ...
  ur: {
    ...
    bazmLoginPrompt: "بزم میں شامل ہونے کے لیے صفحے کے اوپر سے لاگ ان کریں", bazmLoggedInAs: "لاگ ان ہے",
    awSignIn: "لاگ ان کریں",
