...
const SITE_DATA_DEFAULT = {
  ...
  books: [
    ...
    { id: "aina-e-fikr", title: "Aina-e-Fikr", titleUrdu: "آئینۂ فکر", titleHindi: "आईना-ए-फ़िक्र", year: "", cover: "assets/img/aina-e-fikr-cover.jpg", pdf: "assets/pdf/aina-e-fikr.pdf", pdfWeb: "assets/pdf/aina-e-fikr-web.pdf", description: "Fikr-o-khayal par mabni shayeri ka majmua.", pageCount: 330, rtl: true },
    { id: "diwan-e-naseer", title: "Deewan-e-Naseer", titleUrdu: "دیوانِ نصیر", titleHindi: "दीवान-ए-नसीर", year: "2023", cover: "assets/img/diwan-e-naseer-cover.jpg", pdf: "assets/pdf/diwan-e-naseer.pdf", pdfWeb: "assets/pdf/diwan-e-naseer-web.pdf", description: "Naseer Ansari Barabankvi ka deewan — ghazlon aur nazmon ka majmua.", pageCount: 306, rtl: true },
    { id: "zikr-e-karbala", title: "Zikr-e-Karbala", titleUrdu: "ذکرِ کربلا", titleHindi: "ज़िक्र-ए-कर्बला", year: "2024", cover: "assets/img/zikr-e-qarbala-cover.jpg", pdf: "assets/pdf/zikr-e-qarbala.pdf", pdfWeb: "assets/pdf/zikr-e-qarbala-web.pdf", description: "Karbala ke waqiye par mabni marsiye aur kalaam.", pageCount: 370, rtl: true },
